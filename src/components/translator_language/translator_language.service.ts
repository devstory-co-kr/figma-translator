...
} from "./translate_language.interface";

export class TranslateLanguageServiceImpl implements TranslatorLanguageService {
  constructor(
  ...
  // static getLanguageFromString(
  //   languageString: string
  // ): TranslateLanguageServiceImpl | undefined {
  //   return TranslateLanguageServiceImpl.languages.find(
  //     (l) => `${l.name} (${l.q})` === languageString
  //   );
  // }

  // static getTargetLang(node: SceneNode): Record<string, string> {
  //   const firstWord = node.name.split(/[\/\s]+/)[0];
  //   const targetLang = TranslateLanguageServiceImpl.languages.find(
  ...
  // static languages: TranslateLanguageImpl[] = [
  //   { q: "af", name: "Afrikaans" },
  //   { q: "sq", name: "Albanian" },
  //   { q: "am", name: "Amharic" },
  //   { q: "ar", name: "Arabic" },
  ...
  //   { q: "doi", name: "Dogri" },
  //   { q: "nl", name: "Dutch" },
  //   TranslateLanguageServiceImpl.defaultSelectedLanguage,
  //   { q: "eo", name: "Esperanto" },
  //   { q: "et", name: "Estonian" },
  //   { q: "ee", name: "Ewe" },
  //   { q: "fil", name: "Filipino" },
